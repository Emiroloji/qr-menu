// Veri sorumlusu ve hizmet sağlayıcı bilgileri (KVKK aydınlatma metni, kullanım koşulları).
// ÖRNEK BİLGİLERDİR: gerçek şirket bilgileriyle değiştirilip `isExample: false` yapılmalı
// ve metinler yayından önce bir hukukçuya onaylatılmalıdır.

export const COMPANY = {
  isExample: true,
  legalName: "Örnek Yazılım Teknolojileri Ltd. Şti.",
